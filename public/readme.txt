...
２．　ツイキャスには、「グループ限定配信」や「プライベート配信」など、特定のユーザにしか閲覧できない特別な配信があります。本ソフトの通知機能は、これらの配信には対応していません。ただし、限定公開された録画をダウンロードすることは可能です。この場合、「合い言葉」の入力が求められます。
...
第６章　その他
６．１　利用に当たっての注意事項
ULTRAの使用中、以下のようなメッセージが表示されることがあります。
----------
